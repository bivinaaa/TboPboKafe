...
public class UIFinal extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Harap Tunggu Pesananmu diantar");

        jLabel2.setFont(new java.awt.Font("Pristina", 3, 20)); // NOI18N
...
JOptionPane.showMessageDialog(null, "Kalau ada sumur di ladang" +"\n"+ "Bolehlah kita menumpang mandi"+ 
        "\n"+"Kalau ingin bersenang-senang" +"\n"+"Bolehlah mampir kesini lagi");
